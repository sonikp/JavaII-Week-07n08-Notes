...
public class ImageControlSound extends Sound
{
	...
	/**
	   ...
	   */
	  public ImageControlSound(String fileName)
	  {
	   ...
	   */
	  public ImageControlSound (int numSamples)
	  {
	   ...
	   */
	  public ImageControlSound (int numSamples, int sampleRate)
	  {
	    // let the parent class handle this
	   ...
	   */
	  public ImageControlSound (Sound copySound)
	  {
	    // let the parent class handle this
	    super(copySound);
	  }
